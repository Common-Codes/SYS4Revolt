                ...
                try {
                    switch (packet.type) {
                        ...
                        case "Ready": {
                            ...
                            this.client.user = this.client.users.get(packet.users.find((x) => x.relationship === "User")
                                ._id);
                        ...
                        case "ChannelDelete": {
                            (_b = this.client.channels.get(packet.id)) === null || _b === void 0 ? void 0 : _b.delete(true);
                        ...
                        case "ChannelGroupLeave": {
                            (_d = this.client.channels
                                .get(packet.id)) === null || _d === void 0 ? void 0 : _d.updateGroupLeave(packet.user);
                            break;
                        }
                        case "ServerUpdate": {
                        ...
                        case "ServerDelete": {
                            (_e = this.client.servers.get(packet.id)) === null || _e === void 0 ? void 0 : _e.delete(true);
                        ...
                        case "ServerRoleUpdate": {
                            const server = this.client.servers.get(packet.id);
                            if (server) {
                                const role = Object.assign(Object.assign({}, (_f = server.roles) === null || _f === void 0 ? void 0 : _f[packet.role_id]), packet.data);
                        ...
                        case "ServerRoleDelete": {
                            const server = this.client.servers.get(packet.id);
                            if (server) {
                                const _l = (_g = server.roles) !== null && _g !== void 0 ? _g : {}, _m = packet.role_id, _ = _l[_m], roles = __rest(_l, [typeof _m === "symbol" ? _m : _m + ""]);
                                server.roles = roles;
                        ...
                        case "UserUpdate": {
                            (_h = this.client.users
                                .get(packet.id)) === null || _h === void 0 ? void 0 : _h.update(packet.data, packet.clear);
                            break;
                        }
                        ...
                        case "ChannelStopTyping": {
                            (_j = this.client.channels
                                .get(packet.id)) === null || _j === void 0 ? void 0 : _j.updateStopTyping(packet.user);
                            clearInterval(timeouts[packet.id + packet.user]);
                            break;
                        }
                        case "ChannelAck": {
                            (_k = this.client.unreads) === null || _k === void 0 ? void 0 : _k.markRead(packet.id, packet.message_id);
                            break;
                        }
                        case "Pong": {
